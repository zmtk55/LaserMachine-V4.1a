...
export interface ApiCouponCoupon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    maxUses: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<-1>;
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    backDesignState: Schema.Attribute.JSON;
    backFontId: Schema.Attribute.Integer;
    backFontName: Schema.Attribute.String;
    backLogos: Schema.Attribute.JSON;
    backText: Schema.Attribute.String;
    colorName: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    frontDesignState: Schema.Attribute.JSON;
    frontFontId: Schema.Attribute.Integer;
    frontFontName: Schema.Attribute.String;
    frontLogos: Schema.Attribute.JSON;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<
      ['RECEIVED', 'IN_PRODUCTION', 'READY', 'COMPLETED', 'CANCELLED']
    > &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    brand: Schema.Attribute.Enumeration<
      ['YETI', 'Stanley', 'HidroFlask', 'OWALA', 'Generico']
    >;
    category: Schema.Attribute.Enumeration<
      ['Tumblers', 'Travel', 'Bottles', 'Tazas', 'Accesorios ', 'Termos']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    stockThreshold: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStoreConfigStoreConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    baseEngravingPrice: Schema.Attribute.Decimal &
      Schema.Attribute.DefaultTo<100>;
    businessName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'LASERMACHINE'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    extraSidePrice: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<50>;
    facebookUrl: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'lasermachinemexico'>;
    ...
    > &
      Schema.Attribute.Private;
    logoSurcharge: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<50>;
    logoUrl: Schema.Attribute.String;
    nextOrderId: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1000>;
    pointsPercentage: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<5>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    whatsapp: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'526371247095'>;
  };
}
